...
export const BADGE_SETS: BadgeSet[] = [
  ...
  },
  {
    ...
    lede: "You may recognise yourself in more than one. They tend to travel together.",
    cta: CTA,
    ...
    badges: [
      ...
      { icon: "saidmeant", text: "You say yes when you mean no,", emphasis: "then call it keeping the peace.", kind: "site", source: "Live site" },
      { icon: "checklist", text: "You feel most worth something", emphasis: "on the days you were useful.", kind: "new", source: "New, the diagnosis’s core line, softened to the voice guide (25 Sep). Echoes his note: “a man gains self worth from this need”" },
  ...
  },
  {
    ...
    lede: "If two or more of these were true this week, read on.",
    cta: CTA,
  ...
  },
  {
    ...
    band: "02",
    title: "Sometimes the need to achieve <mark>isn’t just ambition.</mark>",
    lede: "Sometimes achievement becomes the place we look for reassurance. It usually looks like this.",
    cta: CTA,
    ...
    badges: [
      { icon: "checklist", text: "Today was a good day", emphasis: "if you got enough done.", kind: "new", source: "New, softened to the voice guide (25 Sep)" },
  ...
  },
  {
    ...
    lede: "Harrison calls these protectors. Everyone has one that steps in first. Most people recognise two.",
    cta: CTA,
  ...
  },
  {
    ...
    band: "02",
    title: "You keep having the same argument — <mark>just with different words.</mark>",
    lede: "Sometimes the disagreement happening today touches something much older.",
    cta: CTA,
    ...
    badges: [
      ...
      { icon: "cycle", text: "The disagreement is today’s.", emphasis: "What it touches is much older.", kind: "new", source: "Voice guide §6 (Dion, 25 Sep)" },
  ...
  },
  {
    ...
    badges: [
      ...
      { icon: "lock", text: "Disciplined in all of it,", emphasis: "and still disconnected.", kind: "team", source: "Voice guide §17: “You can be disciplined and still be disconnected” (Dion, 25 Sep); was the board hook “If discipline has become your hiding place”" },
